...
bit-exact nach Pine exportieren** (Cascade 0.0 diff ✅, Codegen kompiliert ✅, 8/9 Features
bit-exact — Block-1(a) percentrank ✅ 2026-06-08 geschlossen, Block-1(b) htf_4h_rsi_14-Alignment
offen → TV-Verif; dann Block 2 Short+Meta+Selektion). Prio 2: Module fahren sichtbare Signale wo
aktiv. Prio 3: Modul-Discovery-Maschine (INDEX-DIPBUY/METAL nach Pine + neue Klassen).
